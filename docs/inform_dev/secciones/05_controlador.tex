...
\begin{cases}
  \bigl(uCM,\;c,\;0,\;\mathrm{normal},\;\mathrm{llena},\;\infty,\;
    ...
    \mathrm{random}(0,3))])\bigr)
  & \text{si } est_{\mathrm{bolsa}} = \mathrm{vacia} \land c > 0 \\[4pt]
...
\[
  ...
  \begin{cases}
    ...
    \bigl(x,\,cO,\,tol+1,\,est_{\mathrm{flujo}},\,est_{\mathrm{bolsa}},\,\tau',\,
      \mathrm{conLog}(s,\,[((\mathrm{ajustarCaudal},\,cO - x),\,0),\,((\mathrm{registrarEvento},\,\mathrm{snapshot}),\,0)])\bigr)
...
\[
  ...
  \begin{cases}
    ...
    \\ \quad \text{si } est_{\mathrm{bolsa}} \in
...
\[
  ...
  \begin{cases}
    ...
    \\ \quad \text{si } est_{\mathrm{bolsa}} = \mathrm{llena}
    \\[2ex]
    \bigl(uCM,\,cO,\,tol,\,est_{\mathrm{flujo}},\,est_{\mathrm{bolsa}},\;
      \tau_{\mathrm{bolsa}}-e,\;
      [(a_1,\,\max(0,d_1-e)),\,(a_2,d_2),\ldots]\bigr)
    \\ \quad \text{si } est_{\mathrm{bolsa}} \in
      \{\mathrm{bolsaBaja},\,\mathrm{esperandoDetencion},\,\mathrm{vacia}\}
      \land \mathit{acciones} = [(a_1,d_1),(a_2,d_2),\ldots]
  \end{cases}
\]
